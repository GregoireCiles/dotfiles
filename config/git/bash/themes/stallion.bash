...
function __powerline_last_status_prompt {
  ...
  [[ $UID -eq 197609 ]] && symbols+="$(__color ${STATUS_PROMPT_ROOT_COLOR})${STATUS_PROMPT_ROOT}"
...
__color_matrix() {
  ...
  for bgi in "${!colors[@]}"; do
    ...
    for fgi in "${!colors[@]}"; do
      ...
      for modi in "${!mods[@]}"; do
        buffer="${buffer}\e[${modi};${bgn};${fgn}m${POWERLINE_LEFT_SEPARATOR}"
      done
      # echo -ne "\e[m "
      buffer="${buffer}\e[m "
    done
